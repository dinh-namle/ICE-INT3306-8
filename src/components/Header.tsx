...
const Header: React.FC = () => {
  ...
  <header className="bg-main1-1 h-20 flex flex-row fixed top-0 left-0 w-full z-50">
    ...
    <div className="justify-center items-center basis-1/3 flex flex-row">
      ...
      <button onClick={() => handleNavigate("/LeaderBoard")} className="transition ease-in-out duration-100 hover:scale-110 text-white bg-main1-1 text-base font-semibold py-[10px] px-[20px] mx-1 rounded-md">Login</button>
