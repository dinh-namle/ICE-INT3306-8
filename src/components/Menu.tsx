...
const Menu:React.FC<MenuProps> = ({title, sub_title, icon}) => {
              ...
              <ul className='w-full'>
                {sub_title.map((sub, index) => (
                  <li key={index} className='w-full'>
                    <a className='w-full flex flex-row items-center font-light font-sans text-xl text-white ml-8 px-4 py-2 text-left' href='#'>
                      {sub}
                    </a>
                  </li>
                ))}
